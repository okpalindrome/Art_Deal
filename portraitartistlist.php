	...
	<body>
		...
		<!-- The header starts here-->
			<?php include('header.php') ?>
				...
				<BR>
				<BR>
				<p style="font-size:25px;color:#808080" align="center"> EXPLORE GREAT PORTRAIT ARTISTS</p>
				<BR>
				<BR>
<?php 
include('dbcon.php');
$query=mysql_query("select * from artist where is_portrait=1 order by rank_review desc");
